...
export default qrcodegen_default;

/**
 * Render a QR code SVG string for arbitrary URL/text.
 * @param text - the string to encode (e.g. a pairing URL).
 * @returns SVG markup with a 4-module quiet zone.
 */
